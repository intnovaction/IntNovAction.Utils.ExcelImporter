...
{
    [TestClass]
    public class NullableFloat_Should
    {
        private readonly PropertyInfo NullableFloatProperty;

        private NumberNullableCellProcessor<float, SampleImportInto> Processor;
        ...
        public NullableFloat_Should()
        {
            NullableFloatProperty = typeof(SampleImportInto).GetProperty(nameof(SampleImportInto.NullableFloatColumn));
        }

        [TestInitialize()]
        public void Initializer()
        {
            this.Processor = new NumberNullableCellProcessor<float, SampleImportInto>();
        ...
        public void Process_Float_Ok()
        {
            ...
            Cell.Value = 1;
            var cellProcessResult = this.Processor.SetValueFromExcelToObject(ImportResult, ObjectToBeFilled, NullableFloatProperty, Cell);
